  ...
  render() {
    return (
      <div>
        ...
        {this.state.result && this.state.result.error &&  <div className="bg-red-lightest border-l-4 border-red-light text-red-darkest px-4 py-3 m-4 shadow-md">
          <div className="flex">
            <div className="py-1">
            ...
            <div>
              ...
              <p className="text-md border-b-1 border-red"><span className="text-red-light">{this.state.result.error}</span><br/>File: <span className="text-red-light">{this.state.result.file}</span> <br/>Line: <span className="text-red-light">{this.state.result.line}</span></p>
              <pre className="text-xs">
                <code dangerouslySetInnerHTML={{__html:this.state.result.section}}></code>
              </pre>
            </div>
          </div>
        </div>}
        ...
        {this.state.result && <div className="m-2 p-2 bg-blue-darker shadow-lg text-grey-lightest text-xs font-mono">
          <div className="flex border-grey">
            <div className="flex-1 text-center px-4 py-1">
              <span className="text-grey">Memory:</span> {this.state.result.memory}
            </div>
            <div className="flex-1 text-center px-4 py-1">
            <span className="text-grey">Memory Peak:</span> {this.state.result.memory_peak}
            </div>
            <div className="flex-1 text-center px-4 py-1">
            <span className="text-grey">Time:</span> <strong>{this.state.result.time} ms</strong>
            </div>
          </div>
          <div>
            OUTPUT:
